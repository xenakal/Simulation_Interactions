...
constants.ResultsPath.name_simulation = "chapitre4-use_case"
...
plot_scenario(fig2,ax2,controller_ploter_1.data)
plot_scenario(fig2,ax2,controller_ploter_2.data)
