...
for element,color in zip(target_ploter.simulated_data_sort_by_target,colors):
    sc = ax.scatter(element.data_list[7], element.data_list[8], c= np.array(element.data_list[0]), s=500, cmap="Spectral",alpha=0.8)
...
ax3.legend(["generated positions of the target"], fontsize=20,loc=3)
