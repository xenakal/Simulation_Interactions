...
from myCode.my_utils.GUI.button import Button
from myCode.my_utils.GUI.button import ButtonList
from myCode.multi_agent.elements.room import *
...
class GUI_create_map:
    def __init__(self, screen,GUI_option,x_offset,y_offset,scale_x,scale_y):
        ...
        self.GUI_room   = GUI_room(self.screen,self.new_room.agentCams_list,self.new_room.information_simulation.Target_list, x_offset, y_offset, scale_x,
                                                                  scale_y)
