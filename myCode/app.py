...
from myCode.multi_agent.elements.room import Room
from myCode.multi_agent.tools.link_target_camera import *
from myCode.multi_agent.tools.map_region_dyn import *
from myCode.multi_agent.tools.estimator import *
from myCode.multi_agent.agent.agent_interacting_room_camera import AgentCameraCommunicationBehaviour
from myCode.my_utils.GUI.GUI import GUI
from myCode.my_utils.motion import move_Target
from myCode.my_utils.my_IO.IO_map import *
from myCode.my_utils.my_IO.IO_data import *
from myCode.constants import *

import myCode.multi_agent.agent.agent_interacting_room_camera
import myCode.multi_agent.agent.agent_interacting_room_user
from myCode.plot_functions.main_plot import plot_res
...
class App:
    ...
    def init(self):
        ...
        myCode.multi_agent.agent.agent_interacting_room_camera.AgentCam.number_agentCam_created = 0
        myCode.multi_agent.agent.agent_interacting_room_user.AgentUser.number_agentUser_created = 0
