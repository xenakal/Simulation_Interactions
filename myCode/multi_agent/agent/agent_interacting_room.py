...
import myCode.multi_agent.elements.room
from myCode.multi_agent.agent.agent import *
from myCode.multi_agent.tools.memory import *
from myCode.multi_agent.communication.message import *
...
class AgentInteractingWithRoom(Agent):
    ...
    def __init__(self, id, type_agent, t_add, t_del, color=0):
        ...
        self.room_representation = myCode.multi_agent.elements.room.RoomRepresentation(self.color)
