from myCode.constants import TIME_PICTURE, STD_MEASURMENT_ERROR_ACCCELERATION,STD_MEASURMENT_ERROR_SPEED,STD_MEASURMENT_ERROR_POSITION, TIME_SEND_READ_MESSAGE
