from myCode.constants import KALMAN_MODEL_MEASUREMENT_DIM, TIME_SEND_READ_MESSAGE, TIME_PICTURE, \
    STD_MEASURMENT_ERROR_ACCCELERATION, STD_MEASURMENT_ERROR_SPEED, STD_MEASURMENT_ERROR_POSITION
import myCode.constants as constants
from warnings import warn
from filterpy.kalman import KalmanFilter
from myCode.multi_agent.prediction.distributed_kalman_filter import DistributedKalmanFilter
...
class KalmanFilterModel:
    ...
    In order to not mess up the consistency when creating the models at different locations in the myCode, the measurement
    ...
    def kalman_filter_velocity(self, x_init, y_init, vx_init, vy_init):
        ...
        # without having to hard myCode it anywhere else that in this class.
