...
from code.multi_agent.elements.camera import Camera
...
class Room(RoomRepresentation):
    ...
    def add_create_AgentCam(self, cam_x, cam_y, cam_alpha, cam_beta, fix):
        ...
        self.agentCams_list.append(code.multi_agent.agent.agent_interacting_room_camera.AgentCam(camera))
    ...
    def init_AgentUser(self, number=1):
        ...
        for n in range(number):
            ...
            self.agentUser_list.append(code.multi_agent.agent.agent_interacting_room_user.AgentUser())
