...
from code.multi_agent.elements.room import Room
from code.multi_agent.tools.link_target_camera import *
from code.multi_agent.tools.map_region_dyn import *
from code.multi_agent.tools.estimator import *
from code.my_utils.GUI.GUI import GUI
from code.my_utils.motion import move_Target
from code.my_utils.my_IO.IO_map import *
from code.my_utils.my_IO.IO_data import *
from code.constants import *

import code.multi_agent.agent.agent_interacting_room_camera
import code.multi_agent.agent.agent_interacting_room_user
from code.plot_functions.main_plot import plot_res
...
class App:
    ...
    def init(self):
        ...
        code.multi_agent.agent.agent_interacting_room_camera.AgentCam.number_agentCam_created = 0
        code.multi_agent.agent.agent_interacting_room_user.AgentUser.number_agentUser_created = 0
