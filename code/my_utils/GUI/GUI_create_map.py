from code.multi_agent.agent.agent import Agent
from code.multi_agent.elements.target import TargetMotion
from code.my_utils.GUI.GUI_simulation.GUI_room_representation import GUI_room_representation
from code.my_utils.GUI.button import Button
from code.my_utils.GUI.button import ButtonList
from code.multi_agent.elements.room import *
from code.multi_agent.elements.mobile_camera import *
...
class GUI_create_map:
    ...
    def add_camera_to_the_room(self, on, pressed, x_new, y_new):
        ...
        if on and self.button_create_map_3.find_button_state(Button_name.OBJECT_ADD):
            cam = MobileCamera(self.new_room, 0, x_new, y_new, self.alpha_default, self.beta_default, [],d_max=self.depth_default)
